...
import { B as BetterAuthOptions } from '../shared/better-auth.BFooP6d2.mjs';
...
declare const sveltekitCookies: (getRequestEvent: () => Promise<RequestEvent<Partial<Record<string, string>>, string | null>>) => {
