...
import { U as User, S as Session, p as AuthContext, a4 as FieldAttribute, af as InferAdditionalFieldsFromPluginOptions, G as GenericEndpointContext } from '../../shared/better-auth.84gXUliC.cjs';
...
declare const getFullOrganization: <O extends OrganizationOptions>(options: O) => {
    <AsResponse extends boolean = false, ReturnHeaders extends boolean = false>(inputCtx_0: {
        ...
        response: (O["teams"] extends {
            ...
            metadata?: any;
        } & InferAdditionalFieldsFromPluginOptions<"organization", O, true> extends infer T ? { [K in keyof T]: ({
            id: string;
            name: string;
            slug: string;
            createdAt: Date;
            logo?: string | null | undefined;
            metadata?: any;
        } & InferAdditionalFieldsFromPluginOptions<"organization", O, true>)[K]; } : never) : {
            members: InferMember<O>[];
            invitations: InferInvitation<O>[];
        } & ({
            id: string;
            ...
            logo?: string | null | undefined;
            metadata?: any;
        } & InferAdditionalFieldsFromPluginOptions<"organization", O, true> extends infer T_1 ? { [K in keyof T_1]: ({
            id: string;
            name: string;
            slug: string;
            createdAt: Date;
            logo?: string | null | undefined;
            metadata?: any;
        } & InferAdditionalFieldsFromPluginOptions<"organization", O, true>)[K]; } : never)) | null;
    } : (O["teams"] extends {
        enabled: true;
    } ? {
        members: InferMember<O>[];
        ...
        logo?: string | null | undefined;
        metadata?: any;
    } & InferAdditionalFieldsFromPluginOptions<"organization", O, true> extends infer T_2 ? { [K in keyof T_2]: ({
        id: string;
        name: string;
        slug: string;
        createdAt: Date;
        ...
        logo?: string | null | undefined;
        metadata?: any;
    } & InferAdditionalFieldsFromPluginOptions<"organization", O, true> extends infer T_3 ? { [K in keyof T_3]: ({
        id: string;
        name: string;
        slug: string;
        createdAt: Date;
    ...
    endpoints: (O["teams"] extends {
        ...
        createTeam: {
            <AsResponse extends boolean = false, ReturnHeaders extends boolean = false>(...inputCtx: better_call.HasRequiredKeys<better_call.InputContext<"/organization/create-team", {
                ...
                } & InferAdditionalFieldsFromPluginOptions<"team", O, true> extends infer T ? { [K in keyof T]: ({
                    id: string;
                    name: string;
                    organizationId: string;
                    createdAt: Date;
                    updatedAt?: Date | undefined;
                } & InferAdditionalFieldsFromPluginOptions<"team", O, true>)[K]; } : never;
            } : {
                id: string;
                name: string;
                organizationId: string;
                createdAt: Date;
                updatedAt?: Date | undefined;
            } & InferAdditionalFieldsFromPluginOptions<"team", O, true> extends infer T_1 ? { [K in keyof T_1]: ({
                id: string;
                name: string;
                organizationId: string;
                createdAt: Date;
        ...
        createOrganization: {
            <AsResponse extends boolean = false, ReturnHeaders extends boolean = false>(...inputCtx: better_call.HasRequiredKeys<better_call.InputContext<"/organization/create", {
                ...
                response: (({
                    ...
                    logo?: string | null | undefined;
                    metadata?: any;
                } & InferAdditionalFieldsFromPluginOptions<"organization", O, false> extends infer T ? { [K in keyof T]: ({
                    id: string;
                    name: string;
                    slug: string;
                    createdAt: Date;
                    logo?: string | null | undefined;
                    metadata?: any;
                } & InferAdditionalFieldsFromPluginOptions<"organization", O, false>)[K]; } : never) & {
                    metadata: Record<string, any> | undefined;
                    members: (({
                        id: string;
                        organizationId: string;
                ...
                logo?: string | null | undefined;
                metadata?: any;
            } & InferAdditionalFieldsFromPluginOptions<"organization", O, false> extends infer T_1 ? { [K in keyof T_1]: ({
                id: string;
                name: string;
                slug: string;
                createdAt: Date;
