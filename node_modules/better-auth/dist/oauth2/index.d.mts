...
import { p as AuthContext, G as GenericEndpointContext, U as User, L as Account } from '../shared/better-auth.BFooP6d2.mjs';
export { g as generateState, p as parseState } from '../shared/better-auth.C_oxxeck.mjs';
...
declare function getAccessTokenUtil(token: string, ctx: AuthContext): string | Promise<string>;
declare function setTokenUtil(token: string | null | undefined, ctx: AuthContext): string | Promise<string> | null;
...
export { OAuth2Tokens, ProviderOptions, createAuthorizationURL, encodeOAuthParameter, generateCodeChallenge, getAccessTokenUtil, getOAuth2Tokens, handleOAuthUserInfo, refreshAccessToken, setTokenUtil, validateAuthorizationCode, validateToken };
